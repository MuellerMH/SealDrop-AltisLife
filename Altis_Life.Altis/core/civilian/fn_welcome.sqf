...
/*
	File: fn_welcome.sqf
	Author: IIICujoIII (http://death-watch.de/)
...
switch (playerSide) do
{
	case west: 
	{
        _text = [
			...
			format ["<t align='left'>Wenn das dein erster Besuch auf unserem Server ist, bitten wir dich, die Regeln genauestens durchzulesen. Dies kannst Du in unserem Forum: http://death-watch.de/ tun.</t>"],
			...
			format ["<t align='left' color='#428BCA'>TS3 : DeathWatch.nitrado.net</t>"],
			format ["<t align='left' color='#428BCA'>Forum : http://death-watch.de/</t>"]
		];
	};
	case independent:
	{
...
format ["Hallo %1, Willkommen!", name player] hintC _intro;