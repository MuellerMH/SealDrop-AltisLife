...
_chance = random(100);
if(_chance >= 85) then { hint "Der Tankstellenwart hat den Stillenalarm betätigt, die Cops sind auf dem Weg zu dir"; [[1,format["ALARM! - Gasstation: %1 is being robbed!", _shop]],"life_fnc_broadcast",west,false] spawn life_fnc_MP; };

_cops = (west countSide playableUnits);
if(_cops < 4) exitWith{[[_vault,-1],"disableSerialization;",false,false] spawn life_fnc_MP; hint "There isnt enough Police to rob gas station!";};
