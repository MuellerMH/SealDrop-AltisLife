...
if ((getPlayerUID player) in ["76561198023313589","76561198094135955","76561197976232481","76561197978345671"]) then { // Admin PlayerID Eintragen <--- Hier Bitte Alle Admins eintragen!
	...
	if ((getPlayerUID player) in ["76561198023313589","76561198094135955","76561197976232481","76561197978345671"]) then { // Admin PlayerID Eintragen
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["76561198023313589","76561198094135955","76561197976232481","76561197978345671"]) then { // Super Admin PlayerID Eintragen
		adminmenu =
		[
			["",true],
