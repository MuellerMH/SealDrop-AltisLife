...
switch(_type) do
{
	case "187V": {_type = ["Unfälle mit Todesfolge ohne Meldung",10000]};
    ...
    case "18": {_type = ["Nierendiebstahl",200000]};
    ...
    case "24": {_type = ["Verletzung von Sperrgebieten",100000]};
	...
	case "120H": {_type = ["Geschwindigkeitsübertretung in Extremfällen",5000]};
	case "120WL": {_type = ["Schusswaffengebrauch innerhalb von Städten",50000]};
	case "120FS": {_type = ["Schusswaffengebrauch gegen den Staat",100000]};
	default {_type = [];};
};
